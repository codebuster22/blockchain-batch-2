...
// uint - total amount of transaction facilitated by the bank



// 1) Create a contract name - Dbank - done
// 2) Define state varibales - bankName: string ; isActive: bool; contractBalance: uint; amountTransacted: uint - done
// 3) Contract Logic - sendFunds ; getContractBalance
